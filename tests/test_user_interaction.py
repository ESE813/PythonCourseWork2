...
def vacancies():
    return [
        Vacancy("Python Dev", "https://api.hh.ru/vacancies", 120000, "Опыт работы с Python и Django"),
        Vacancy("Java Dev", "https://api.hh.ru/vacancies", 100000, "Spring Framework, Java"),
        Vacancy("Frontend Dev", "https://api.hh.ru/vacancies", 90000, "React, JavaScript"),
...
# def test_print_vacancies_output(capsys, vacancies):
#     print_vacancies([vacancies[0]])
#     captured = capsys.readouterr()
#     assert "Вакансия: Python Dev" in captured.out
