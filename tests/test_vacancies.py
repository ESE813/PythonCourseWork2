import pytest
from src.vacancies import Vacancy  # путь укажи по своему проекту
...
def test_repr_output():
    ...
    assert repr(v1) == "Vacancy('Django Dev', salary: 80000руб., url: https://example.com)"

    v2 = Vacancy("Go Dev", "https://example.com", None, "desc")
    assert repr(v2) == "Vacancy('Go Dev', salary: Зарплата не указана, url: https://example.com)"