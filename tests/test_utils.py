...
from src.utils import vacancy_to_dict, dict_to_vacancy, cast_to_object_list
...
# def test_cast_to_object_list(sample_dict):
#     data = [sample_dict, {"invalid": "data"}, 123, None]
#     result = cast_to_object_list(data)
#     assert len(result) == 1
#     assert isinstance(result[0], Vacancy)
#     assert result[0].get_title == "Python Developer"